...
pub use combat::{
    default_registry, AggregateStrengthV1, AttackOutcome, CepheusDamageType, CepheusVehicleV1,
    CepheusWeapon, CombatContext, CombatResolver, LegacyLinearV1, ResolverRegistry, RulesetId,
    AGGREGATE_STRENGTH_V1, CEPHEUS_VEHICLE_V1, LEGACY_LINEAR_V1,
};
